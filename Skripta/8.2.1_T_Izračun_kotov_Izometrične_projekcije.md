...
$$ n_{POV} = \mathbf{R}^{-1}e_y = \frac{1}{\sqrt{3}} \begin{bmatrix} 1 \\1 \\1 \end{bmatrix} \approx \begin{bmatrix} 0.5774 \\0.5774 \\0.5774 \end{bmatrix} $${#eq:normalni_vektor_izometricne}
