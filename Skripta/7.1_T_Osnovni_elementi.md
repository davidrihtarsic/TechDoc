...
Poleg simbola je pogosto navedena tudi vrednost upora, izražena v ohmih. Vrednosti se zapisujejo s standardnimi predponami, kot so kiloohm (kΩ) in megaohm (MΩ). Na [@fig:upor_simbol] je prikazan simbol upora.
