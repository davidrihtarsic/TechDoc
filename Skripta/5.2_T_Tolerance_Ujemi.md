...
![Pripis enote v polje tolerance.](./slike/Tolerance_pripis_enote.png){#fig:Tolerance_pripis_enote}
...
Pri ohlapnem ujemu je luknja vedno večja od gredi, zato med elementoma nastane **zračnost** (glej [@tbl:lega_tolerančnega_polja]).Na primer, zelo pogosto uporabljamo ujem H7/g6, ki se uporablja pri: drsnih spojih, gibljivih mehanizmih. V kolikor je potrebno nekoliko več prostora za mazanje z mastjo pa celo H8/f7.
