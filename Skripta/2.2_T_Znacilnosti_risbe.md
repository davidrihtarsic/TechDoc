...
Standard predpisuje, da so črte različnih debelin razdeljene v **skupine**, pri čemer se prehod med skupinami izvede s faktorjem $\sqrt{2}$. Naslednja [@tbl:skupina_crt] prikazuje najbolj pogosto izbrane skupine črt z določenimi debelinami črt.
